...
import com.android.argb.edhlc.colorpicker.ColorPickerSwatch.OnColorSelectedListener;

/**
 * A dialog which takes in as input an array of colors and creates a icon_palette allowing the user to
