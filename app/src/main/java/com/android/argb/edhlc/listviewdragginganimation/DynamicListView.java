...
public class DynamicListView extends ListView {
    ...
    public ArrayList<String> mDynamicArrayListContent;
    ...
    public ArrayList<String> getDynamicArrayListContent() {
        return mDynamicArrayListContent;
    }

    public void setDynamicArrayListContent(ArrayList<String> list) {
        mDynamicArrayListContent = list;
    }
    ...
    private Bitmap getBitmapWithBorder(View v) {
        ...
        RectF rectF = new RectF(RADIUS, RADIUS, bitmap.getWidth() - RADIUS, bitmap.getHeight() - RADIUS);

        Paint paint = new Paint();
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(LINE_THICKNESS);
        paint.setColor(getResources().getColor(R.color.edh_default_secondary));

        can.drawBitmap(bitmap, 0, 0, null);
        can.drawRoundRect(rectF, RADIUS, RADIUS, paint);
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mDynamicArrayListContent, originalItem, getPositionForView(switchView));
