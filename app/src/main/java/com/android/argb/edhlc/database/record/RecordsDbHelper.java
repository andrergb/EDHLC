...
public class RecordsDbHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "create table "
            ...
            + RecordsContract.RecordsEntry.COLUMN_DATE + " text not null, "

            + RecordsContract.RecordsEntry.COLUMN_TOTAL_PLAYERS + " text not null, "
            ...
            + RecordsContract.RecordsEntry.COLUMN_FOURTH_PLAYER_DECK + " text);";
