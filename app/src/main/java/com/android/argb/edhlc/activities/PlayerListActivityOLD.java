...
public class PlayerListActivityOLD extends AppCompatActivity {
        ...
        if (view != null) {
            ...
            mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                    ...
                    Intent intent = new Intent(PlayerListActivityOLD.this, DeckActivity.class);
                    ...
                    PlayerListActivityOLD.this.finish();
                    return false;
                }
            });
            ...
            mExpandableListView.setOnGroupCollapseListener(new ExpandableListView.OnGroupCollapseListener() {
                ...
                public void onGroupCollapse(int groupPosition) {
                    ...
                    Intent intent = new Intent(PlayerListActivityOLD.this, PlayerActivity.class);
                    intent.putExtra("PLAYERNAME", listDataHeader.get(groupPosition)[0]);
                    startActivity(intent);
                }
            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playerlist_old);
        activity = this;
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!tempName.equalsIgnoreCase("")) {
                    ...
                    if (decksDB.addDeck(new Deck(player, tempName, new int[]{PlayerListActivityOLD.this.getResources().getColor(R.color.primary_color), PlayerListActivityOLD.this.getResources().getColor(R.color.secondary_color)}, colorIdentity, date)) != -1) {
